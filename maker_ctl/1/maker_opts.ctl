...
genome=data/48498_ref_ofav_dov_v1_unplaced.fa #genome sequence (fasta file or fasta embeded in GFF3 file)
...
est=data/ESM3_Bleaching_O-faveolata_transcriptome.fasta #set of ESTs or assembled mRNA-seq in fasta format
...
#-----Gene Prediction
snaphmm=snap/ofav.hmm #SNAP HMM file
gmhmm= #GeneMark HMM file
augustus_species=BUSCO_ofav_3399920038 #Augustus gene prediction species model
